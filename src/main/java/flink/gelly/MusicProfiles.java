...
public class MusicProfiles implements ProgramDescription {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println ( " the user song graph edges are    ");
		userSongGraph.getEdges().print();
		...
		System.out.println (" the edges of the similar users graph  ");
		similarUsersGraph.getEdges().print();
